...
export type HeroBlock = { title: string; subtitle: string; ctaLabel: string; ctaHref: string; cta2Label: string; cta2Href: string; imageUrl: string; imageAlt: string };
...
export const HOME_DEFAULTS = {
  hero: { title: "", subtitle: "", ctaLabel: "", ctaHref: "/shop", cta2Label: "", cta2Href: "/shop?isNew=1", imageUrl: "", imageAlt: "" } as HeroBlock,
